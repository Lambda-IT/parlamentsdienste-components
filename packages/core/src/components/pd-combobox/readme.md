...
| `selected`                  | `selected`                    | To select an item by prop. Needs to be an object with an id property, a string or a number.                                | `DropdownItemSelect[] \| Pick<DropdownItem, "id"> & Partial<Omit<DropdownItem, "id">> \| number \| string` | `undefined`                                                         |
