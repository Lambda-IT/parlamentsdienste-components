...
| `emptyItemData`   | `empty-item-data`   | Data used for the empty item                                 | `SortDropdownItem`   | `{         id: '0',         label: '-',         value: null,         sort: null,     }` |
| `itemCount`       | `item-count`        | Items visible in dropdown                                    | `number`             | `7`                                                                                     |
| `items`           | `items`             | Items to display and select in dropdown                      | `SortDropdownItem[]` | `[]`                                                                                    |
...
| `reverseItemData` | `reverse-item-data` | Data used for the reverse item at the bottom of the dropdown | `SortRevertItem`     | `{         label: 'Sort. Umkehren',         selected: false,     }`                     |
