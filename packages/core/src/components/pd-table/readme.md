...
| --------------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `columns`             | `columns`               | A definition for each column of the table                                                                                                                               | `PdColumn[]`                         | `[]`                                                                                                                                                               |
...
| `iconConfig`          | `icon-config`           | The configuration for the last column, the icon column                                                                                                                  | `PdTableIconConfiguration`           | `undefined`                                                                                                                                                        |
| `menuLabel`           | `menu-label`            |                                                                                                                                                                         | `string`                             | `undefined`                                                                                                                                                        |
| `minWidth`            | `min-width`             | The minimum width the table should take                                                                                                                                 | `string`                             | `'300'`                                                                                                                                                            |
| `pageSizes`           | `page-sizes`            | Available Page sizes for paging                                                                                                                                         | `DropdownItem[]`                     | `[         { id: '1', label: '10', value: 10, selected: true },         { id: '2', label: '25', value: 25 },         { id: '3', label: '100', value: 100 },     ]` |
...
| `rows`                | `rows`                  | The data definition for each row to display                                                                                                                             | `PdTableRow[]`                       | `[]`                                                                                                                                                               |
