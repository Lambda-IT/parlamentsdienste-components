...
| `rows`               | `rows`                 | The number of visible text lines for the control.                                                                                                                                | `number`                                                                              | `1`         |
...
| `viewOnly`           | `view-only`            | If `true`, the textarea is replaced with a simple text                                                                                                                           | `boolean`                                                                             | `false`     |
