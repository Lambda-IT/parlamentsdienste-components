...
const DropdownItem = /*@__PURE__*/ proxyCustomElement(class DropdownItem extends H {
    ...
    iconSrc;
    render() {
        return (h(Host, { key: '15faef9bc569d278f3a46b9ff666405ad97d5f55' }, h("div", { key: '23c58758b540c53cd8eba3ea71437afdc33907ff', class: { 'pd-dropdown-item': true, 'pd-dropdown-item-selected': this.selected && !this.multiselect } }, this.multiselect ? h("pd-checkbox", { checked: this.selected }) : null, this.iconName || this.iconSrc ? (h("span", { class: "pd-dropdown-item-icon" }, h("pd-icon", { name: this.iconName ?? null, src: this.iconSrc ?? null, size: 2 }))) : (''), h("span", { key: '11e7000b2a50dac018cf560f5ea2c4721ac76474', innerHTML: this.strong(this.value, this.highlight?.toString()), "data-test": "pd-dropdown-item-text" }))));
    }
    escapeRegExp(string) {
...
//# sourceMappingURL=p-BrFKqHg2.js.map
