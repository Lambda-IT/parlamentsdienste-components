...
import { d as defineCustomElement$1 } from './p-BY6sf1aF.js';
...
const Chip = /*@__PURE__*/ proxyCustomElement(class Chip extends H {
    ...
    render() {
        ...
        const role = 'button';
        const iconSize = 1.25;
        return (h("button", { key: 'ba6c6d140de8d4584078c5e6d407497f5370a734', disabled: disabled, role: role, class: {
                'pd-chip': true,
                'pd-chip-checked': this.checked || type === 'toggle' ? true : false,
                'pd-chip-disabled': this.disabled,
                'pd-chip-readonly': this.readonly,
                [`pd-chip-${type}`]: true,
            } }, type === 'filter' && this.checked && (h("div", { key: '0706afc5e30f6d3d70ceeed0594779dead2d042b', class: "pd-chip-icon pd-chip-icon-left" }, h("pd-icon", { key: 'd9c34453396e303ba0c3cfe51975ff7e372f60e0', size: iconSize, name: "confirm_bold" }))), h("slot", { key: '1c21c6afe14e8f6163f83c1da7a2c1b254a1c86f' }), type === 'toggle' && !this.readonly && (h("button", { key: 'a3b385cf9b84b89c09be7c5d567b1c2ac60db171', "data-test": "pd-chip-remove", tabindex: this.disabled || this.readonly ? '-1' : null, class: "pd-chip-remove pd-chip-icon pd-chip-icon-right", onClick: e => this.removeClicked(e) }, h("pd-icon", { key: 'ad2733af40f2ab41e8d5c6cc4c92254d28ef87cc', size: iconSize, name: "close_bold" })))));
    }
...
//# sourceMappingURL=p-B8-y08KT.js.map
