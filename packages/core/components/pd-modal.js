...
const Modal = /*@__PURE__*/ proxyCustomElement(class Modal extends H {
    ...
    render() {
        return (h(Host, { key: '721dba81a6ebabdb30e7d41904a3aacf399f1f3b', style: {
                zIndex: this.config?.zIndex ?? null,
            } }, h("focus-trap", { key: '8713bb7d093b4b896071116e12004e499c8056e1' }, h("pd-backdrop", { key: '29b93ce42249216e90d1964f7238639ef4d99017', visible: this.config?.backdropVisible ?? false }), h("div", { key: '5f728edd53958bb5eb22880260cbc99bde7056a0', tabindex: "0", role: "dialog", class: "pd-modal-wrapper" }, h("div", { key: '99b53b11dab4db5423d13e40cc2f44812b704436', class: "pd-modal-header" }, h("span", { key: 'c99efa8762ecc77b5e646e3f00f0598b60ddef2f', class: "pd-modal-title", "data-test": "pd-modal-title" }, this.config?.title), h("button", { key: '98d832600796a703a65bdd1a18a3f49aec5446b4', class: "pd-modal-close", onClick: () => this.closeModal(), "data-test": "pd-modal-close" }, h("pd-icon", { key: 'c64031d267ec3f0ab12eac6b099de5bc33768c08', name: "close", size: 2 }))), h("div", { key: '296b842dd7321dc771ee48364470f90bcd24403b', class: "pd-modal-content" }, h("slot", { key: 'e6b1007b6eb16c0346f864a02f5b3f1ad006c6d2' })), h("div", { key: '6b37f00a34b274bbb644dfcb81c80cf0b3366497', class: "pd-modal-footer" }, h("slot", { key: 'e890db4d0156737752dc0e9501cbf55899b401e7', name: "footer" }))))));
    }
