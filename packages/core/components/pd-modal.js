...
import { d as defineCustomElement$3 } from './p-DVJMuUig.js';
...
const Modal = /*@__PURE__*/ proxyCustomElement(class Modal extends H {
    ...
    render() {
        return (h(Host, { key: '3d83ef74d6ab4f72002c817e4b29f9b7d1ef67aa', style: {
                zIndex: this.config?.zIndex ?? null,
            } }, h("focus-trap", { key: 'd39ee4bbc3fd982379ff360cd12532df9dcc9edc' }, h("pd-backdrop", { key: 'f7ddd4133b60df8823dba2a1e278f97a7d19750e', visible: this.config?.backdropVisible ?? false }), h("div", { key: '1b398acc39bdf1fe7120c95b54a10c40d528a32a', tabindex: "0", role: "dialog", class: "pd-modal-wrapper" }, h("div", { key: 'ebcb00a1ec1051706b2ae29e25c6bcdd639e9830', class: "pd-modal-header" }, h("span", { key: '08dc9a958aa5c70d763ae3c60746a9d7977dd592', class: "pd-modal-title", "data-test": "pd-modal-title" }, this.config?.title), h("button", { key: '3281b333c1d3a9d560687bfb7dd4613e3205dbf9', class: "pd-modal-close", onClick: () => this.closeModal(), "data-test": "pd-modal-close" }, h("pd-icon", { key: '3df6491a8ed6ab5ee9f25548f28cc2611bbcf524', name: "close", size: 2 }))), h("div", { key: 'fb4d3ecbc36153038bfebf7724273fa6ba6ae75d', class: "pd-modal-content" }, h("slot", { key: '5df3c1f90d0a372f88543bc48ebbda9968028d00' })), h("div", { key: '85b20949a17d7ff86c1e38caf81b8fa2061cc84b', class: "pd-modal-footer" }, h("slot", { key: 'f26d93ac6f8f5e56f4ba32b3671f323985d5d85a', name: "footer" }))))));
    }
