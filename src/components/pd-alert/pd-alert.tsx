...
export class Alert implements ComponentInterface, ComponentDidLoad {
    ...
    return (
      <div
        class={{
          ...
          'pd-alert-has-status': !this.hideIcon && (this.color === 'danger' || this.color === 'success' || this.color === 'warning' || this.color === 'info'),
        }}
      >
        {this.renderIcon()}
  ...
  private renderAction() {
    ...
    return (
      <TagType class="pd-alert-action-text" {...typeAttrs} onClick={() => this.handleAction()} data-test="pd-alert-action">
