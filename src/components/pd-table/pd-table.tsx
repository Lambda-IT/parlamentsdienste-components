...
import { DropdownItem, PdColumn, PdPagingLocation, PdStatus, PdTableIconConfiguration, PdTableRow, PdTableStyle, SelectedEvent } from '../../types';
import {
    btnCellStyle,
    calcFixedFlex,
    calcFixedMinWidth,
...
export class Table implements ComponentInterface, ComponentWillLoad, ComponentDidLoad, ComponentDidUpdate {
        ...
        const columns = this.columns
            ...
            .map((headerCol, i) => {
                ...
                return (
                    ...
                    >
                        <div class="pd-table-header-cell-text" style={{ justifyContent: getTextAlign(headerCol.textAlign) }}>
        ...
        if (this.state.filterValues[headerCol.columnName])
            return (
                <button class="pd-table-filter-clear" onClick={ev => this.openFilter(ev, headerCol.columnName)}>
                    ...
                    <button class="pd-table-filter-clear-button" onClick={ev => this.clearFilter(ev, headerCol.columnName)}>
    ...
    private renderShowStatus() {
        ...
        return (
            ...
            >
                <div class="pd-table-header-cell-text" style={{ justifyContent: getTextAlign(btnCellStyle.align) }}></div>
                <div class="pd-table-header-cell-actions"></div>
            </div>
        );
    }
            ...
            >
                {this.paging && !this.externalRowHandling ? (
                    [
                        ...
                        ></pd-pagination>,
                        <pd-dropdown items={this.pageSizes} onPd-change={ev => this.pageSizeChanged(ev)} data-test="pd-table-pagination-dropdown"></pd-dropdown>,
                    ]
                ) : (
