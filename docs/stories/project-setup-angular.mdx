...
4. To add fonts and icons add this objectsto the `angular.json` assets array:
    ...
    ```json
        "assets": [
              {
                "glob": "**/*",
                "input": "node_modules/@parlamentsdienste/core/dist/parlamentsdienstecore/assets",
                "output": "assets"
              },
        ]
    ```
...
5. To add the base styles and fonts add these two lines to the `styles` array in `angular.json`:
    ...
    ```json
        "styles": [
            "node_modules/@parlamentsdienste/core/dist/parlamentsdienstecore/typography.css",
            "node_modules/@parlamentsdienste/core/dist/parlamentsdienstecore/parlamentsdienstecore.css"
        ],
    ```
